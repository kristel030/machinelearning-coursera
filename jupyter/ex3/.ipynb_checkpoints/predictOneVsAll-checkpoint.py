from numpy import append, zeros, ones, argmax
from sigmoid import sigmoid

def predictOneVsAll(all_theta, X_data):
    """
    ...
    # X = m x n
    #   m = number of examples/measurements
    #   n = number of parameters

    # p = m x 1
    #   p = number of examples
    #   p(m) = a value from 1 till 10, representing the digit in exmample m

    # p_intermediate = m x i
    #   m = number of measurements
    #   i = number of classifiers

    p_intermediate = sigmoid(X @ all_theta.T)
    p = argmax(p_intermediate, axis=1) 
